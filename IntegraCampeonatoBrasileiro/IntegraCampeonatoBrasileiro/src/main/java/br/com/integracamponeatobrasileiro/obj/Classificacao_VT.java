...
public class Classificacao_VT implements Serializable {
    ...
    public int hashCode() {
        ...
        hash = 41 * hash + this.mandante;
        hash = 41 * hash + this.visitante;
        return hash;
    }
    ...
    public boolean equals(Object obj) {
        ...
        final Classificacao_VT other = (Classificacao_VT) obj;
    ...
    public String toString() {
        return "Classificacao_VT{" + "total=" + total + ", cdEquipe=" + cdEquipe + ", mandante=" + mandante + ", visitante=" + visitante + '}';
    }
